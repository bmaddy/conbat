...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t2982) {
      cljs.core.t2982 = {};
      cljs.core.t2982 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta2983 = c;
      ...
      cljs.core.t2982.cljs$lang$type = !0;
      cljs.core.t2982.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t2982")
      };
      cljs.core.t2982.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t2982")
      };
      var c = cljs.core.t2982.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t2982.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t2982.prototype.cljs$core$Fn$ = !0;
      cljs.core.t2982.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta2983
      };
      cljs.core.t2982.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t2982(this.meta, this.f, b)
      }
    }
    return new cljs.core.t2982(b, a, null)
  }(), b)
};
...
conbat.node = {};
conbat.node.http = cljs.nodejs.require.call(null, "http");
conbat.node.fs = cljs.nodejs.require.call(null, "fs");
conbat.node.success = function(a, b) {
  a.writeHead(200, {"Content-Type":b});
  return a
};
conbat.node.init = "\n  .........\n  ..*......\n  ....*....\n  .**..***.";
conbat.node.str__GT_state = function(a) {
  return function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(var e = a;;) {
        if(cljs.core.seq.call(null, e)) {
          var f = cljs.core.first.call(null, e), g = cljs.core.nth.call(null, f, 0, null), h = cljs.core.nth.call(null, f, 1, null), f = function(a, c, d, e) {
            return function n(a) {
              return new cljs.core.LazySeq(null, !1, function() {
                for(var c = a;;) {
                  if(cljs.core.seq.call(null, c)) {
                    var d = cljs.core.first.call(null, c), f = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
                    if(cljs.core._EQ_.call(null, f, "*")) {
                      return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray([d, e], !0), n.call(null, cljs.core.rest.call(null, c)))
                    }
          ...
          if(g = cljs.core.seq.call(null, f.call(null, cljs.core.map.call(null, cljs.core.vector, clojure.string.trim.call(null, g), cljs.core.range.call(null))))) {
            return cljs.core.concat.call(null, g, c.call(null, cljs.core.rest.call(null, e)))
          }
          e = cljs.core.rest.call(null, e)
        }else {
          return null
  ...
  }.call(null, cljs.core.map.call(null, cljs.core.vector, clojure.string.split_lines.call(null, clojure.string.trim.call(null, a)), cljs.core.range.call(null)))
};
conbat.node.state = cljs.core.atom.call(null, cljs.core.zipmap.call(null, conbat.node.str__GT_state.call(null, conbat.node.init), cljs.core.repeat.call(null, "\ufdd0'Server")));
conbat.node.players = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
conbat.node.get_state = function(a, b) {
  conbat.node.success.call(null, b, "text/plain");
  return b.end(cljs.core.pr_str.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'state", "\ufdd0'players"], {"\ufdd0'state":cljs.core.deref.call(null, conbat.node.state), "\ufdd0'players":cljs.core.deref.call(null, conbat.node.players)})))
};
conbat.node.get_ip = function(a) {
  var b = a.headers["x-forwarded-for"];
  return cljs.core.truth_(b) ? b : a.connection.remoteAddress
};
conbat.node.update_state = function(a, b) {
  var c = cljs.core.atom.call(null, "");
  a.addListener("data", function(a) {
    return cljs.core.swap_BANG_.call(null, c, cljs.core.str, a)
  });
  return a.addListener("end", function() {
    cljs.core.println.call(null, [cljs.core.str(conbat.node.get_ip.call(null, a)), cljs.core.str(": "), cljs.core.str(cljs.core.deref.call(null, c))].join(""));
    var d = cljs.core.map.call(null, cljs.core.vector, cljs.reader.read_string.call(null, cljs.core.deref.call(null, c)), cljs.core.repeat.call(null, conbat.node.get_ip.call(null, a)));
    cljs.core.swap_BANG_.call(null, conbat.node.state, cljs.core.merge, d);
    return b.end("true")
  })
};
conbat.node.colors = cljs.core.PersistentHashSet.fromArray("\ufdd0'Indigo \ufdd0'Blue \ufdd0'FireBrick \ufdd0'OrangeRed \ufdd0'Green \ufdd0'Turquoise \ufdd0'Gold \ufdd0'SlateGray \ufdd0'MediumVioletRed".split(" "));
conbat.node.make_color = function() {
  var a = clojure.set.difference.call(null, conbat.node.colors, cljs.core.map.call(null, function(a) {
    return(new cljs.core.Keyword("\ufdd0'color")).call(null, cljs.core.second.call(null, a))
  }, cljs.core.deref.call(null, conbat.node.players)));
  return cljs.core.empty_QMARK_.call(null, a) ? [cljs.core.str("#"), cljs.core.str(cljs.core.rand_int.call(null, 16777216).toString(16))].join("") : cljs.core.rand_nth.call(null, cljs.core.seq.call(null, a))
};
conbat.node.update_players = function(a, b) {
  return cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, function d(b) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, b)) {
          var f = cljs.core.first.call(null, b), g = cljs.core.nth.call(null, f, 0, null), f = cljs.core.nth.call(null, f, 1, null), h = a.call(null, g, cljs.core.ObjMap.EMPTY);
          return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray([g, cljs.core.ObjMap.fromObject(["\ufdd0'score", "\ufdd0'name", "\ufdd0'color"], {"\ufdd0'score":f, "\ufdd0'name":h.call(null, "\ufdd0'name", g), "\ufdd0'color":h.call(null, "\ufdd0'color", conbat.node.make_color.call(null, g))})], !0), d.call(null, cljs.core.rest.call(null, b)))
        }
        return null
      }
    }, null)
  }.call(null, cljs.core.frequencies.call(null, cljs.core.map.call(null, cljs.core.second, b))))
};
conbat.node.game_loop = function game_loop(b) {
  return setTimeout(function() {
    cljs.core.swap_BANG_.call(null, b, conbat.core.step);
    cljs.core.swap_BANG_.call(null, conbat.node.players, conbat.node.update_players, cljs.core.deref.call(null, b));
    cljs.core.println.call(null, cljs.core.deref.call(null, conbat.node.players));
    return game_loop.call(null, b)
  }, 50)
};
conbat.node.get_game = function(a, b) {
  cljs.core.println.call(null, conbat.node.get_ip.call(null, a));
  conbat.node.success.call(null, b, "text/html");
  return b.end([cljs.core.str('<html>\n            <head>\n              <title>Conbat</title>\n              <\!-- <script src="/ui.js" type="text/javascript"><\/script> --\>\n              <link href="/main.css" rel="stylesheet" type="text/css">\n            </head>\n            <body>\n              <div>\n                <div id="game-board"> </div>\n                <div class="game-info">\n                  <div id="stamp-board"> </div>\n                  <div id="leader-board"> </div>\n                </div>\n                <script src="/ui.js" type="text/javascript"><\/script>\n                <script type="text/javascript">//<![CDATA[\n                //goog.events.listen(window, goog.events.EventType.LOAD, function(){\n                //document.ready = function(){\n                  //conbat.repl.connect(window.location.hostname);\n                  conbat.ui.init({ip: \''), 
  cljs.core.str(conbat.node.get_ip.call(null, a)), cljs.core.str("'});\n                //};\n              //]]\><\/script>\n              </div>\n            </body>\n            </html>")].join(""))
};
conbat.node.get_file = function(a, b, c, d) {
  conbat.node.success.call(null, d, a);
  return d.end(conbat.node.fs.readFileSync(b))
};
conbat.node.routes = cljs.core.ObjMap.fromObject(["/", "/state", "/update", "/ui.js", "/main.css"], {"/":conbat.node.get_game, "/state":conbat.node.get_state, "/update":conbat.node.update_state, "/ui.js":cljs.core.partial.call(null, conbat.node.get_file, "text/javascript", "ui.js"), "/main.css":cljs.core.partial.call(null, conbat.node.get_file, "text/css", "main.css")});
conbat.node.handler = function(a, b) {
  cljs.core.println.call(null, "Request: ", a.url);
  var c = conbat.node.routes.call(null, a.url, null);
  if(cljs.core.truth_(c)) {
    return c.call(null, a, b)
  }
  b.writeHead(404);
  return b.end("Not Found\n")
};
...
cljs.core._STAR_main_cli_fn_STAR_ = conbat.node.start;
cljs.nodejscli = {};
